...
```
```{r}
table(data$What.is.your.age.)
```

Demographics
```{r}
library(ggplot2)
levels(data$How.many.employees.does.your.company.or.organization.have.)
```

Columns to use
How.many.employees.does.your.company.or.organization.have.
X.strong.Are.you.self.employed...strong.
Is.your.employer.primarily.a.tech.company.organization.  
Do.you.believe.your.productivity.is.ever.affected.by.a.mental.health.issue.  hue with age
...
What.is.your.age.
```{r}
data2 <- data[(data$How.many.employees.does.your.company.or.organization.have. != ""), ]
levels(data2$How.many.employees.does.your.company.or.organization.have.)
```

```{r}
ggplot(data = data2, aes(How.many.employees.does.your.company.or.organization.have.))+geom_bar() + xlab("Company Size")
ggsave("ComapnySize.png")
```


```{r}
ggplot(data = data, aes(What.is.your.gender.))+geom_bar() + xlab("Gender") + ylab(("Count"))
ggsave("Gender.png")
```
```{r}
str(data[(data$X.strong.Are.you.self.employed...strong. != 1), ])
```

```{r}
ggplot(data = data, aes(What.country.do.you..strong.live..strong..in.))+geom_map() + xlab("Gender")
